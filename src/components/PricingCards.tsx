      ...
      <div className="relative bg-slate-900/90 rounded-3xl border border-slate-700 p-8 overflow-hidden">
        <div className="relative">
          ...
          <Link
            ...
            className="block w-full text-center px-4 py-3.5 rounded-xl font-bold text-base transition-all border border-slate-600 text-white hover:bg-slate-800 hover:border-slate-500 mb-2"
          >
            Talk to Sales
          </Link>
          <p className="text-center text-xs text-slate-500 mb-7">
