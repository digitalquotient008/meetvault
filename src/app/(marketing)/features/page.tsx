...
const all_features = [
  { icon: Users, title: 'Client CRM', description: "Every client\u2019s visit history, spending, notes, and contact info in one place. Know who\u2019s in the chair before they sit down." },
  { icon: Scissors, title: 'Service Menu', description: 'List your cuts, fades, beards, and more with prices and durations. Clients see exactly what you offer.' },
  { icon: Clock, title: 'Smart Scheduling', description: 'Set your hours, add buffers between appointments, and block off time. No double-bookings, ever.' },
  { icon: Bell, title: 'Appointment Reminders', description: 'Automatic email reminders before each appointment. Fewer no-shows, zero effort from you.' },
  { icon: ListOrdered, title: 'Walk-in Queue', description: 'Manage walk-ins with a digital queue. Clients know their spot. You stay focused on the cut.' },
  { icon: ClipboardList, title: 'Waitlist', description: "When you\u2019re fully booked, clients join the waitlist. First in line when a slot opens up." },
    ...
    <div className="bg-slate-950 min-h-screen">
      ...
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-amber-400 font-semibold text-sm uppercase tracking-widest mb-3">Built for independent barbers</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Stop losing money.
              <br />
              <span className="bg-gradient-to-r from-amber-400 to-amber-500 bg-clip-text text-transparent">Start running your book.</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-400 leading-relaxed">
              Online booking, deposits, no-show protection, client history, walk-in queue, and growth tools — all in one place. 14-day free trial. $25/month.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Link href="/sign-up" className="bg-amber-500 text-slate-950 px-8 py-4 rounded-xl font-bold text-lg hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20 text-center">
                Start 14-day free trial
              </Link>
              <Link href="/pricing" className="border border-slate-600 text-slate-200 px-8 py-4 rounded-xl font-semibold hover:border-slate-500 hover:text-white transition-colors text-center">
                See pricing
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {hero_features.map((f) => {
              const Icon = f.icon;
              return (
                <div key={f.title} className="bg-slate-900/80 border border-slate-800 rounded-2xl p-8 hover:border-slate-700 transition-all group">
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-amber-400 font-semibold text-sm uppercase tracking-widest mb-3">Before &amp; after</p>
      ...
      <section className="py-20 sm:py-28 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-amber-400 font-semibold text-sm uppercase tracking-widest mb-3">Full feature set</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Everything in one dashboard</h2>
            <p className="text-slate-400 text-lg">No add-ons, no extra tools. It all comes included for $25/month.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {all_features.map((f) => {
              const Icon = f.icon;
              return (
                <div key={f.title} className="bg-slate-800/50 border border-slate-700/60 rounded-2xl p-7 hover:border-slate-600 transition-colors group">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-gradient-to-br from-amber-600/10 to-amber-500/5 border border-amber-500/20 rounded-3xl p-10 md:p-16 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link href="/sign-up" className="inline-flex bg-amber-500 text-slate-950 px-8 py-4 rounded-xl font-bold hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20">
