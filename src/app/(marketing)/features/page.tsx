...
export const metadata = {
  title: 'Features',
  description: 'Booking, deposits, no-show protection, and client history for barbershops.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Booking & payments for barbershops
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-6 hover:border-slate-600 transition-colors">
              ...
              <p className="text-slate-400">
                One link, deposits to cut no-shows, client history and notes. Reminders you control—no spam.
              </p>
            </div>
            <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-6 hover:border-slate-600 transition-colors">
              <h3 className="text-xl font-semibold text-white mb-3">Barbershops</h3>
              <p className="text-slate-400">
                Multiple barbers, shared calendar. Deposits, cancellation fees, reliable payment confirmation.
              </p>
            </div>
            <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-6 hover:border-slate-600 transition-colors">
              <h3 className="text-xl font-semibold text-white mb-3">Stylists & nail techs</h3>
              <p className="text-slate-400">
                Set services and hours, share your link. Get paid upfront or in-shop. Client notes in one place.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-800/80 rounded-2xl p-8 md:p-12 border border-slate-700">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-slate-400 max-w-3xl mx-auto">Advanced features coming soon</p>
            </div>
